...
lyr_Vergers_Cotentin_AOC_0.set('fieldLabels', {'IDU': 'header label', 'NOM_COM': 'header label', 'INAO': 'header label', 'NOM_VERGER': 'header label', 'ID_VERGER': 'header label', 'MO': 'header label', 'AR': 'header label', 'AO': 'header label', 'CP': 'header label', 'SURFACE_HA': 'header label', 'SURF_PLANT': 'header label', 'N_SURFPLAN': 'header label', });
