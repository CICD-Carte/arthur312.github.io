...
var style_PourcentageAutres_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("P_AUTRE");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 21.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 21.000000 && value <= 42.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 42.000000 && value <= 63.000000) {
            style = [ new ol.style.Style({
