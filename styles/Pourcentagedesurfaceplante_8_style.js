...
var style_Pourcentagedesurfaceplante_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value > 2.340000 && value <= 33.066667) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 33.066667 && value <= 63.793333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 63.793333 && value <= 94.520000) {
            style = [ new ol.style.Style({
